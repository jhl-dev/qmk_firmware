...
[DEF] = LAYOUT(
	...
	KC_1,			    LA_SYM,				KC_SPC,				MT(MOD_LCTL, KC_ENT),	KC_CAPS,		KC_NUM,	MT(MOD_LALT, KC_BSPC),	OSM(MOD_LSFT),		LA_NAV,				KC_4
),
...
[SYM] = LAYOUT(
	...
	KC_HOME,	KC_LEFT,		KC_DOWN,		KC_RGHT,		KC_END,				KC_MINS,	KC_4,		KC_5,		KC_6,			KC_QUOT,
